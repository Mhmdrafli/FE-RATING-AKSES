...
export default function SessionQRPage() {
  ...
  return (
    <div className="max-w-[480px] mx-auto">
      <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-gray-600 mb-4 text-sm hover:text-[#0076D0]">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-8 print:border-none print:shadow-none">
        ...
        <div className="flex gap-2 print:hidden">
          <button onClick={copy} className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg border border-gray-300 hover:bg-gray-50 text-sm">
